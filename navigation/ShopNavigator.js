...
const CartNavigator = createStackNavigator({
  Cart: CartScreen,
  ShippingDetailsScreenSelect: ShippingDetailsScreenSelect,
...
const tabScreenConfig = {
  ...
  Feed: {
    ...
    navigationOptions: {
      tabBarIcon: (tabInfo) => {
        return <Ionicons name="rss" size={25} color={tabInfo.tintColor} />;
      },
    },
  },
  Messages: {
    ...
    navigationOptions: {
      tabBarIcon: (tabInfo) => {
        return <Ionicons name="comments" size={25} color={tabInfo.tintColor} />;
      },
    },
  },
  Cart: {
    ...
    navigationOptions: {
      tabBarIcon: (tabInfo) => {
        return (
          <Ionicons name="cart-plus" size={25} color={tabInfo.tintColor} />
        );
      },
    },
  },
  ...
  Account: {
    ...
    navigationOptions: {
      tabBarIcon: (tabInfo) => {
        return <Ionicons name="user-alt" size={25} color={tabInfo.tintColor} />;
      },
    },
  },
};
